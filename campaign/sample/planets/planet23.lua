...
local function GetPlanet(planetUtilities, planetID)
	...
	local planetData = {
      ...
      messagesOverTime = {
        ...
        messages = {
          [       2     *30    ] = "enemy control nodes identified",
          [       3     *30    ] = "warning: increased enemy activity detected",
          [       3     *30 + 2] = "estimated time before decisive enemy counterattack: 25 minutes",
          
          [    5*60     *30    ] = "20 minutes before decisive enemy counterattack",
          [   10*60     *30    ] = "15 minutes before decisive enemy counterattack",
          [   15*60     *30    ] = "10 minutes before decisive enemy counterattack",
          [   20*60     *30    ] = "5 minutes before decisive enemy counterattack",
          [  (20*60     *30)+ 2] = "warning: large-scale enemy orbital activity detected",
          [  (20*60     *30)+ 4] = "immediate action recommended",
          
          [   21*60     *30    ] = "4 minutes before decisive enemy counterattack",
          [   22*60     *30    ] = "3 minutes before decisive enemy counterattack",
          [   22*60     *30    ] = "3 minutes before decisive enemy counterattack",
          [   23*60     *30    ] = "2 minutes before decisive enemy counterattack",
          
          [ ((23*60)+40)*30    ] = "orbital power spike detected",
          [   24*60     *30    ] = "1 minutes before decisive enemy counterattack",
          [ ((24*60)+30)*30    ] = "large-scale enemy naval activity detected",
          [ ((24*60)+40)*30    ] = "large-scale enemy land activity detected",
          [ ((24*60)+45)*30    ] = "warning: enemy orbital weapons detected",
          [ ((24*60)+50)*30    ] = "ALERT: ENEMY ORBITAL WEAPONS POWERING UP",
          [ ((24*60)+55)*30    ] = "ALERT: ENEMY ORBITAL WEAPONS ONLINE",
          
          [ ((24*60)+57)*30    ] = "ALERT: ENEMY ORBITAL WEAPONS CYCLING",
          [ ((24*60)+58)*30    ] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [ ((24*60)+59)*30    ] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [ ((24*60)+59)*30 +10] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [ ((24*60)+59)*30 +20] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [ ((24*60)+59)*30 +24] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [ ((24*60)+59)*30 +26] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [ ((24*60)+59)*30 +28] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [ ((24*60)+59)*30 +29] = "ALERT: ENEMY ORBITAL WEAPONS ACTIVATING",
          [   25*60     *30    ] = "ALERT: ENEMY ORBITAL STRIKE DETECTED",
        },
      },
		},
		completionReward = {
