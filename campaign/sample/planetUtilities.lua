...
planetUtilities.messages = {
  ...
  enemyProdDestroyed = "critical enemy production system destroyed",
  enemyEnergyDestroyed = "critical enemy energy generator destroyed",
  enemyResourceGenDestroyed = "critical enemy resource generator destroyed",
  enemyDepotDestroyed = "enemy resource depot destroyed",
  enemyDefenseDestroyed = "critical enemy defense system destroyed",
  enemyNukeDestroyed = "enemy strategic nuclear silo destroyed",
  enemyAntiNukeDestroyed = "enemy anti-nuclear defense destroyed",
  enemyArtyDestroyed = "enemy fixed artillery position destroyed",
